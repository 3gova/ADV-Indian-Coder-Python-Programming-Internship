...
#print (BASE_DIR2) if we check the directory works or not with the print statement
...
SECRET_KEY = 'django-insecure-fw1r_$fo%4z(yx+uawa%u@*k#!1h(i=8m+^9dipl4_0g05g@2k'
